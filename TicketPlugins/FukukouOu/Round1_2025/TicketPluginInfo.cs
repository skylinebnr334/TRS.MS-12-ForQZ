...
namespace TRS.TMS12.TicketPlugins.FukukouOu.Round1_2025
{
    ...
    public class PluginInfo:BindableBase, ITicketPluginExtension
    {
        ...
        public string TicketName { get; } = "Round 1 2025";
        ...
        public void SetDefault(string option = "")
        {
            ...
            if (option == "")
            {
                ...
                TextBoxes[(int)InputControlTextBox.Stage] = Strings.StrConv(((Sender)Sender).Get_NextRound().current_stage.ToString(), VbStrConv.Wide);
                TextBoxes[(int)InputControlTextBox.NextQuestion] = Strings.StrConv(2.ToString(),VbStrConv.Wide);
