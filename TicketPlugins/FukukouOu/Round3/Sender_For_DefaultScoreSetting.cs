...
namespace TRS.TMS12.TicketPlugins.FukukouOu.Round3
{
    public class Sender_For_DefaultScoreSetting : ISender
    {
        ...
        public SendResult Send()
        {
            ...
            var sendObj = new Round3_I_ScoreConfig_JSONData()
            {
                correct = correct,
                miss = miss,
                ask_throw = ask_throw,
            ...
            return Connector.SendScoreConfigR3(sendObj);

            //return SendResult.No("Err");
        }
        public Round3_I_ScoreConfig_JSONData get_DefaultScoreConfig()
        {
            return Connector.get_DefaultScoreConfigR3();
        }
